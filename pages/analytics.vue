      ...
      <div class="card" style="border: 1px solid #f3f8fb; border-radius: 10px;box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
        <div class="card-body">
          ...
          <div class="row align-items-center g-0 mt-3">
            <div class="col-sm-3">
              <p class="text-truncate mt-1 mb-0">
                <i class="mdi mdi-circle-medium text-info me-2"></i> Twitter
              </p>
            </div>
            <div class="col-sm-9">
              <div class="progress mt-1" style="height: 6px">
          ...
          <div class="row align-items-center g-0 mt-3">
            <div class="col-sm-3">
              <p class="text-truncate mt-1 mb-0">
                <i class="mdi mdi-circle-medium text-success me-2"></i> Facebook
              </p>
            </div>
            <div class="col-sm-9">
              <div class="progress mt-1" style="height: 6px">
          ...
          <div class="row align-items-center g-0 mt-3">
            <div class="col-sm-3">
              <p class="text-truncate mt-1 mb-0">
                <i class="mdi mdi-circle-medium text-warning me-2"></i>
                Instagram
              </p>
            </div>
            <div class="col-sm-9">
