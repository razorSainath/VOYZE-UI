<template>
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Maintenance | Minible - Admin & Dashboard Template</title>
                                    ...
                                    <div class="card mt-4 maintenance-box">
                                        <div class="card-body p-4">
                                            <div class="avatar-sm mx-auto mb-4">
                                                <div class="avatar-title rounded-circle font-size-20" style="color:#009dc2; background-color: #DCEFF3;">
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <p class="text-muted mb-0">If you are going to use a passage of Lorem
                                                Ipsum, you need to be sure there isn't anything embar.. <a
                                                        href="mailto:no-reply@voyze.io"
                                                        style="color:#009dc2;">no-reply@voyze.io</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
