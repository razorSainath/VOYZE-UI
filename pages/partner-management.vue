      ...
      >
        ...
        <div class="page-title-right">
          <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active">Partners Management</li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <table class="table table-centered table-nowrap mb-0">
              ...
              <tbody>
                <tr>
                  ...
                  <td>received</td>
                  <td>I don't think we will be able to continue the deal.</td>
                  <td>Viren Jangra</td>
                  <td>Viren Jangra</td>
                  <td>2021-01-03</td>
                  <td>
                    ...
                    <ul class="list-inline mb-0">
                      <li class="list-inline-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                          ...
                          <a class="dropdown-item" href="#">Revoke</a>
                        </div>
                      </li>
                    </ul>
                  </td>
  ...
  <div class="modal" id="manageUser">
    <div class="modal-dialog">
      <div class="modal-content">
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Razorlabz User's</h4>
          <button type="button" class="btn-close" data-dismiss="modal"></button>
        </div>
          ...
          <div class="row py-1">
            <div class="col-md-12">
              ...
              <select name="" id="" class="form-control">
                ...
                <option value="2">Razorlabz</option>
              </select>
            </div>
          </div>
        </div>
  ...
  <div class="modal" id="revoke">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <p>Do you really want to revoke the request?</p>
          <div class="row py-1">
