    ...
    <div id="layout-wrapper">
          ...
          <div class="d-flex">
            ...
            <div class="navbar-brand-box">
              <a href="index.html" class="logo logo-dark">
                <span class="logo-sm">
                  <img src="/uploads/images/logo-sm.png" alt="" height="22" />
                </span>
                <span class="logo-lg">
                  <img
                    src="/uploads/images/logo-light.svg"
                    alt=""
                    height="20"
                  />
                </span>
                ...
                <div data-simplebar style="max-height: 230px">
                  ...
                  >
                    <div class="d-flex align-items-start">
                      <div class="flex-shrink-0 me-3">
                        <img
                          src="/uploads/images/users/avatar-3.jpg"
                      ...
                      <div class="flex-grow-1">
                        ...
                        <div class="font-size-12 text-muted">
                          ...
                          <p class="mb-0">
                            <i class="mdi mdi-clock-outline"></i> 1 hour ago
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    <div class="d-flex align-items-start">
                      <div class="flex-shrink-0 me-3">
                        <img
                          src="/uploads/images/users/avatar-4.jpg"
                          class="rounded-circle avatar-xs"
                          alt="user-pic"
                        />
                      </div>
            ...
            <div class="dropdown d-inline-block">
              ...
              >
                <img
                  ...
                  src="/uploads/images/users/avatar-2.jpg"
                  alt="Header Avatar"
                />
                <span
      ...
      <div class="vertical-menu">
        ...
        <div class="navbar-brand-box">
          <a href="index.html" class="logo logo-dark">
            ...
            <span class="logo-lg">
              <img src="/uploads/images/logo-light.svg" alt="" height="20" />
            </span>
          </a>
        </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row align-items-center g-0 mt-3">
                      <div class="col-sm-3">
                        <p class="text-truncate mt-1 mb-0">
                          <i class="mdi mdi-circle-medium text-info me-2"></i>
                          iPhones
                        </p>
                      </div>
                      <div class="col-sm-9">
                    ...
                    <div class="row align-items-center g-0 mt-3">
                      <div class="col-sm-3">
                        <p class="text-truncate mt-1 mb-0">
                          <i class="mdi mdi-circle-medium text-purple me-2"></i>
                          Cables
                        </p>
                      </div>
                      <div class="col-sm-9">
                  ...
                  <div class="card-body">
                    <div class="float-end">
                      <div class="dropdown">
                        ...
                        >
                          <span class="text-muted"
                            >All Members<i class="mdi mdi-chevron-down ms-1"></i
                          ></span>
                        </a>
                        ...
                        >
                          <tbody>
                            ...
                            <tr>
                              <td>
                                <img
                                  src="/uploads/images/users/avatar-5.jpg"
                                  class="avatar-xs rounded-circle"
                                  alt="..."
                                />
                              </td>
                            ...
                            <tr>
                              <td>
                                <img
                                  src="/uploads/images/users/avatar-6.jpg"
                                  class="avatar-xs rounded-circle"
                                  alt="..."
                                />
                              </td>
                            ...
                            <tr>
                              <td>
                                <img
                                  src="/uploads/images/users/avatar-7.jpg"
                                  class="avatar-xs rounded-circle"
                                  alt="..."
                                />
                              </td>
                            ...
                            <tr>
                              <td>
                                <img
                                  src="/uploads/images/users/avatar-8.jpg"
                                  class="avatar-xs rounded-circle"
                                  alt="..."
                                />
                              </td>
                            ...
                            <tr>
                              <td>
                                <img
                                  src="/uploads/images/users/avatar-1.jpg"
                                  class="avatar-xs rounded-circle"
                                  alt="..."
                                />
                              </td>
                      ...
                      <li class="feed-item">
                        <div class="feed-item-list">
                          <p class="text-muted mb-1 font-size-13">
                            Today<small class="d-inline-block ms-1"
                              >12:20 pm</small
                            >
                          </p>
                          <p class="mb-0">
                            ...
                            new article:
                            <span class="text-primary">Forget UX Rowland</span>
                          </p>
                        </div>
                      </li>
                      <li class="feed-item">
                      ...
                      <div class="col-6">
                        <div class="social-source text-center mt-3">
                          <div class="avatar-xs mx-auto mb-3">
                            ...
                            >
                              <i
                                class="fa-brands fa-linkedin-in text-white"
                              ></i>
                            </span>
                          </div>
      ...
      <footer class="footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              © 2021 - Razorlabz Software Private Limited.
            </div>
            <div class="col-sm-6">
          ...
          <div class="p-4">
            ...
            <div class="form-check sidebar-setting">
              <input
                ...
                value="colored"
              />
              <label class="form-check-label" for="sidebar-color-colored"
                >Colored</label
              >
            </div>
