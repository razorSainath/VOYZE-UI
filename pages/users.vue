                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3  float-md-end">
                                                <a href="javascript:void(0);"
                                                    class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#addUser"><i
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span>Nibhash Mishra</span></td>
                                                    <td>Megha Seth</td>
                                                    <td>nibhash@razorlabz.com</td>
                                                    <td>Leader, Admin</td>
                                                    <td>Client Admin</td>
                                                    <td>Asia/Kolkata</td>
                                                    <td>2021-01-03</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>2022-12-06</td>
                                                    <td>
                                                        <div class="badge bg-pill bg-soft-danger font-size-12">Inactive
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <ul class="list-inline mb-0">
