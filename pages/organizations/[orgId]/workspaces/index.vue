  ...
  <head>
    ...
    <div class="flex">
                            ...
                            <div class="flex-initial">
                                <button type="button" class="bg-cyan-500 rounded-full py-2 mb-2 float-right" data-bs-toggle="modal" data-bs-target="#workspace">
        ...
        <div class="card-body">
          <div class="d-flex align-items-start">
            <div class="flex-shrink-0 me-4">
              <div class="avatar-sm">
                <span
                  class="avatar-title bg-soft-success text-primary font-size-16 rounded-circle"
                >
                  R
                </span>
              </div>
            ...
            <div class="flex-grow-1 align-self-center">
              <div class="border-bottom pb-1">
                <h5 class="text-truncate font-size-16 mb-1">
                  <a href="#" class="text-dark">Razorpod</a>
                </h5>
              </div>
              <div class="row">
                <div class="col-6">
        ...
        <div class="card-body">
          <div class="d-flex align-items-start">
            <div class="flex-shrink-0 me-4">
              <div class="avatar-sm">
                <span
                  class="avatar-title bg-soft-danger text-primary font-size-16 rounded-circle"
                >
                  R
                </span>
              </div>
            ...
            <div class="flex-grow-1 align-self-center">
              <div class="border-bottom pb-1">
                <h5 class="text-truncate font-size-16 mb-1">
                  <a href="#" class="text-dark">Razorlabz</a>
                </h5>
              </div>
              <div class="row">
                <div class="col-6">
        ...
        <div class="card-body">
          <div class="d-flex align-items-start">
            ...
            <div class="flex-grow-1 align-self-center">
              <div class="border-bottom pb-1">
                <h5 class="text-truncate font-size-16 mb-1">
                  <a href="#" class="text-dark">Infoysis</a>
                </h5>
              </div>
              <div class="row">
                <div class="col-6">
        ...
        <div class="card-body">
          <div class="d-flex align-items-start">
            ...
            <div class="flex-grow-1 align-self-center">
              <div class="border-bottom pb-1">
                <h5 class="text-truncate font-size-16 mb-1">
                  <a href="#" class="text-dark">Tata Consultancy Services</a>
                </h5>
              </div>
              <div class="row">
                <div class="col-6">
        ...
        <div class="card-body">
          <div class="d-flex align-items-start">
            ...
            <div class="flex-grow-1 align-self-center">
              <div class="border-bottom pb-1">
                <h5 class="text-truncate font-size-16 mb-1">
                  <a href="#" class="text-dark">Wipro</a>
                </h5>
              </div>
              <div class="row">
                <div class="col-6">
